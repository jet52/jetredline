...
- **Issue 14** (bundle jetcite): RESOLVED in v3.5.0 — vendored jetcite source in `lib/jetcite/` (same approach as jetmemo). `make vendor-jetcite` copies from `../jetcite/src/jetcite`. No pip install or wheel needed.
