...
---
*Generated by JetRedline v4.0.3 (2026-04-25)*
...
Then write a `via.json` mapping each citation to the tier from the Pass 3B **Via** column (`{"2024 ND 156": "ndcourts-mcp", …}`) and generate the page. Omit `--via-json` if Pass 3B did not run, `--sources-meta` if the export exited 2 (no backend), and `--passages-json` if Pass 3B wrote no passages ledger:
